...
@include('stoke-crud::fields.inc.wrapper_start')
        ...
        @if($activeInlineCreate)
            @include('stoke-crud::fields.relationship.inline_create_button', ['field' => $field])
        @endif
<select
        ...
        @if($activeInlineCreate)
            @include('stoke-crud::fields.relationship.field_attributes')
        @endif

        @include('stoke-crud::fields.inc.attributes', ['default_class' =>  'form-control select2_field'])
