...
@include('stoke-crud::fields.inc.wrapper_start')
    ...
    @else
        <input type="text" data-marker="multipleBrowseInput" name="{{ $field['name'] }}" value="{{ $value }}" @include('stoke-crud::fields.inc.attributes') readonly>
    @endif
</div>
    ...
    <script type="text/html" data-marker="browse_multiple_template">
        <div class="input-group input-group-sm">
            <input type="text" @include('stoke-crud::fields.inc.attributes') readonly>
