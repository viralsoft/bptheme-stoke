...
@section('header')
	  <h2 class="mb-sm-0 font-size-20">
        ...
        <small class="text-default font-size-14">{!! $crud->getSubheading() ?? trans('backpack::crud.edit').' '.$crud->entity_name !!}.</small>
		...
		@include('stoke-crud::inc.grouped_errors')
		  ...
		  {!! method_field('PUT') !!}
		    ...
		    @endif
		      ...
		      @else
		      	@include('stoke-crud::form_content', ['fields' => $crud->fields(), 'action' => 'edit'])
		      @endif
