...
class PublishView extends Command
{
     ...
     * @var string
     */
    protected $signature = 'stoke:publish
     ...
     * @var string
     */
    public $sourcePath = 'vendor/themebackpack/stoke/src/resources/views/';
     ...
     * @var string
     */
    public $destinationPath = 'resources/views/vendor/stoke/';
