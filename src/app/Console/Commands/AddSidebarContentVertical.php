...
namespace ViralSoft\BPThemeStoke\app\Console\Commands;

use Illuminate\Console\Command;
use Illuminate\Support\Facades\Storage;

class AddSidebarContentVertical extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'stoke-vertical:add-sidebar-content
    ...
    {
        $path = 'resources/views/vendor/stoke/base/inc/sidebar_content_vertical.blade.php';
